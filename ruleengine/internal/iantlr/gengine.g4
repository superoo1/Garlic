...
statement : ifStmt | functionCall | methodCall  | threeLevelCall | assignment | concStatement  | forStmt | breakStmt |forRangeStmt | continueStmt | aggStmt;
...
// 聚合运算 到时都记录下来
aggStmt: COUNT LR_BRACKET  expression  RR_BRACKET  countOperator  extreValue WITHIN  expireTime timeForm;
...
countOperator : GT | LT | GTE | LTE | EQUALS | NOTEQUALS ;
