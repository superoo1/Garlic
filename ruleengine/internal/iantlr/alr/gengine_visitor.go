...
type gengineVisitor interface {
	...
	// Visit a parse tree produced by gengineParser#aggStmt.
	VisitAggStmt(ctx *AggStmtContext) interface{}
	...
	// Visit a parse tree produced by gengineParser#timeForm.
	VisitTimeForm(ctx *TimeFormContext) interface{}

	// Visit a parse tree produced by gengineParser#expireTime.
	VisitExpireTime(ctx *ExpireTimeContext) interface{}

	// Visit a parse tree produced by gengineParser#extreValue.
	VisitExtreValue(ctx *ExtreValueContext) interface{}
	...
	// Visit a parse tree produced by gengineParser#countOperator.
