...
func (v *BasegengineVisitor) VisitAggStmt(ctx *AggStmtContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasegengineVisitor) VisitTimeForm(ctx *TimeFormContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegengineVisitor) VisitExpireTime(ctx *ExpireTimeContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegengineVisitor) VisitExtreValue(ctx *ExtreValueContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasegengineVisitor) VisitCountOperator(ctx *CountOperatorContext) interface{} {
	return v.VisitChildren(ctx)
}
