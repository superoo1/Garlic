...
type gengineListener interface {
	...
	// EnterAggStmt is called when entering the aggStmt production.
	EnterAggStmt(c *AggStmtContext)
	...
	// EnterTimeForm is called when entering the timeForm production.
	EnterTimeForm(c *TimeFormContext)

	// EnterExpireTime is called when entering the expireTime production.
	EnterExpireTime(c *ExpireTimeContext)

	// EnterExtreValue is called when entering the extreValue production.
	EnterExtreValue(c *ExtreValueContext)
	...
	// ExitAggStmt is called when exiting the aggStmt production.
	ExitAggStmt(c *AggStmtContext)
	...
	// ExitTimeForm is called when exiting the timeForm production.
	ExitTimeForm(c *TimeFormContext)

	// ExitExpireTime is called when exiting the expireTime production.
	ExitExpireTime(c *ExpireTimeContext)

	// ExitExtreValue is called when exiting the extreValue production.
	ExitExtreValue(c *ExtreValueContext)
