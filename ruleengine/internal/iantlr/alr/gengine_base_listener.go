...
// EnterAggStmt is called when production aggStmt is entered.
func (s *BasegengineListener) EnterAggStmt(ctx *AggStmtContext) {}

// ExitAggStmt is called when production aggStmt is exited.
func (s *BasegengineListener) ExitAggStmt(ctx *AggStmtContext) {}
...
// EnterTimeForm is called when production timeForm is entered.
func (s *BasegengineListener) EnterTimeForm(ctx *TimeFormContext) {}

// ExitTimeForm is called when production timeForm is exited.
func (s *BasegengineListener) ExitTimeForm(ctx *TimeFormContext) {}

// EnterExpireTime is called when production expireTime is entered.
func (s *BasegengineListener) EnterExpireTime(ctx *ExpireTimeContext) {}

// ExitExpireTime is called when production expireTime is exited.
func (s *BasegengineListener) ExitExpireTime(ctx *ExpireTimeContext) {}

// EnterExtreValue is called when production extreValue is entered.
func (s *BasegengineListener) EnterExtreValue(ctx *ExtreValueContext) {}

// ExitExtreValue is called when production extreValue is exited.
func (s *BasegengineListener) ExitExtreValue(ctx *ExtreValueContext) {}
...
func (s *BasegengineListener) EnterCountOperator(ctx *CountOperatorContext) {}

// ExitCountOperator is called when production countOperator is exited.
func (s *BasegengineListener) ExitCountOperator(ctx *CountOperatorContext) {}
